...
<main class="container">
    ...
    <form action="loginSuccessView.php" id="loginSuccessDetail" class="loginSuccess" method="post">
        ...
        <button type="submit" name="renewLicense" onclick="myFunction2()" <?php echo (($_SESSION["lisensedate"]=="")||($_SESSION["verified"]=="No")) ? 'disabled="true"' : '';?> >Re-new License</button>
    </form>
...
<script type="text/javascript">
    ...
    function myFunction2() {
        alert("You are done. Please check your email");
    }
</script>
